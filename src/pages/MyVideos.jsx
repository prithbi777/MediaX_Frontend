            ...
            <div key={v.id} className="rounded-xl bg-white dark:bg-slate-900 shadow-md overflow-hidden transition-colors">
              ...
              <div className="p-4">
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation()
                    navigate(`/user/${v.uploadedBy._id || v.uploadedBy}`)
                  }}
                  className="text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors mt-1 text-left"
                >
                  Uploaded by {v.uploaderName || 'You'}
                </button>
